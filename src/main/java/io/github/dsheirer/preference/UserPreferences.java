...
public class UserPreferences implements Listener<PreferenceType>
{
    ...
    /**
     * Streaming heartbeat monitor preferences
     */
    public StreamHeartbeatPreference getStreamHeartbeatPreference()
    {
        return mStreamHeartbeatPreference;
    }

    /**
     * Software (application alive) heartbeat monitor preferences
     */
    public SoftwareHeartbeatPreference getSoftwareHeartbeatPreference()
    {
        return mSoftwareHeartbeatPreference;
    }
